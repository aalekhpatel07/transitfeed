...
class StopTimeValidationTestCase(util.ValidationTestCase):
    def runTest(self):
        ...
        self.ExpectInvalidValueInClosure(
            "arrival_time",
            "1a:00:00",
            lambda: transitfeed.StopTime(self.problems, stop, arrival_time="1a:00:00"),
        )
        self.ExpectInvalidValueInClosure(
            "departure_time",
            "1a:00:00",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="10:00:00", departure_time="1a:00:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "pickup_type",
        ...
        self.ExpectInvalidValueInClosure(
            ...
            "10:00:00",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="11:00:00", departure_time="10:00:00"
            ),
        )
        ...
        self.ExpectInvalidValueInClosure(
            ...
            "10:70:00",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="10:00:00", departure_time="10:70:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "departure_time",
            "10:00:62",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="10:00:00", departure_time="10:00:62"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "arrival_time",
            "10:00:63",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="10:00:63", departure_time="10:10:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "arrival_time",
            "10:60:00",
            lambda: transitfeed.StopTime(
                self.problems, stop, arrival_time="10:60:00", departure_time="11:02:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "stop",
            "id",
            lambda: transitfeed.StopTime(
                self.problems, "id", arrival_time="10:00:00", departure_time="11:02:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "stop",
            "3",
            lambda: transitfeed.StopTime(
                self.problems, "3", arrival_time="10:00:00", departure_time="11:02:00"
            ),
        )
        self.ExpectInvalidValueInClosure(
            "stop",
            None,
            lambda: transitfeed.StopTime(
                self.problems, None, arrival_time="10:00:00", departure_time="11:02:00"
            ),
        )
        ...
        transitfeed.StopTime(
            self.problems, stop, arrival_time="1:00:00", departure_time="1:05:00"
        )
        transitfeed.StopTime(
            self.problems, stop, arrival_time="24:59:00", departure_time="25:05:00"
        )
        transitfeed.StopTime(
            self.problems, stop, arrival_time="101:01:00", departure_time="101:21:00"
        )
