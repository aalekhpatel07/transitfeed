...
class ServicePeriodValidationTestCase(util.ValidationTestCase):
    ...
    def testServicePeriodDateOutsideValidRange(self):
        ...
        self.ValidateAndExpectDateOutsideValidRange(period2, "start_date", "18990101")
...
class ServicePeriodTestCase(util.TestCase):
    def testActive(self):
        ...
        self.assertFalse(
            period_dates.IsActiveOn(date="20071229", date_object=date(2007, 12, 29))
        )
        ...
        self.assertFalse(
            period_no_end.IsActiveOn(date="20071231", date_object=date(2007, 12, 31))
        )
...
class ExpirationDateTestCase(util.TestCase):
    def runTest(self):
        accumulator = util.RecordingProblemAccumulator(self, ("NoServiceExceptions"))
