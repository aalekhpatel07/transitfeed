...
class TestKMLGeneratorMethods(util.TestCase):
    ...
    def testCreateFolderVisible(self):
        ...
        self.assertEqual(
            _ElementToString(element), "<Folder><name>folder_name</name></Folder>"
        )
    ...
    def testCreateFolderNotVisible(self):
        ...
        self.assertEqual(
            ...
            "<Folder><name>folder_name</name>" "<visibility>0</visibility></Folder>",
        )
    ...
    def testCreatePlacemark(self):
        ...
        self.assertEqual(
            _ElementToString(element), "<Placemark><name>abcdef</name></Placemark>"
        )
    ...
    def testCreatePlacemarkWithStyle(self):
        ...
        self.assertEqual(
            _ElementToString(element),
            "<Placemark><name>abcdef</name>" "<styleUrl>#ghijkl</styleUrl></Placemark>",
        )

    def testCreatePlacemarkNotVisible(self):
        element = self.kmlwriter._CreatePlacemark(self.parent, "abcdef", visible=False)
        self.assertEqual(
            _ElementToString(element),
            "<Placemark><name>abcdef</name>" "<visibility>0</visibility></Placemark>",
        )
...
class TestRouteKML(util.TestCase):
    ...
    def testCreateRouteTripsFolderAltitude0(self):
        ...
        self.assertEqual(
            _ElementToString(trip_placemark.find("LineString")),
            "<LineString><tessellate>1</tessellate>"
...
class TestShapePointsKML(util.TestCase):
    ...
    def testCreateShapePointsFolder(self):
        ...
        self.assertEqual(shape_point_folder.find("name").text, "shape_1 Shape Points")
