...
class TestPoints(ShapeLibTestBase):
    def testPoints(self):
        ...
        self.assertPointApproxEq(p.Normalize(), Point(1 / norm, 1 / norm, 1 / norm))
    ...
    def testS2LatLong(self):
        ...
        self.assertPointApproxEq(Point(0.663413948169, 0.556670399226, 0.5), point)
    ...
    def testGetDistanceMeters(self):
        ...
        self.assertApproxEq(8732.623770873237, point1.GetDistanceMeters(point2))
...
class TestPoly(ShapeLibTestBase):
    ...
    def testCutAtClosestPoint(self):
        ...
        (before, after) = poly.CutAtClosestPoint(Point(0, 0.3, 0.7).Normalize())
