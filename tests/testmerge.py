...
def CreateAgency():
    ...
    return transitfeed.Agency(
        name="agency", url="http://agency", timezone="Africa/Johannesburg", id="agency"
    )
...
class TestApproximateDistanceBetweenPoints(util.TestCase):
    ...
    def testDegenerate(self):
        p = (30.0, 30.0)
        self._assertWithinEpsilon(merge.ApproximateDistanceBetweenPoints(p, p), 0.0)
...
class TestSchemedMerge(util.TestCase):
    ...
    def setUp(self):
        ...
        self.fm = merge.FeedMerger(
            a_schedule, b_schedule, merged_schedule, TestingProblemReporter(accumulator)
        )
    ...
    def testMergeIdenticalCaseInsensitive(self):
        ...
        self.assertTrue(self.ds._MergeIdenticalCaseInsensitive("abc", "AbC") == "AbC")
        self.assertRaises(
            merge.MergeError, self.ds._MergeIdenticalCaseInsensitive, "abc", "bcd"
        )
        self.assertRaises(
            merge.MergeError, self.ds._MergeIdenticalCaseInsensitive, "abc", "ABCD"
        )
    ...
    def testSchemedMerge_Failure(self):
        ...
        self.assertRaises(merge.MergeError, self.ds._SchemedMerge, scheme, a, b)
...
class TestServicePeriodMerger(util.TestCase):
    ...
    def testUnion(self):
        ...
        CheckAttribs(self.sp1, self.fm.a_merge_map[self.sp1], fields, self.assertEqual)
        CheckAttribs(self.sp2, self.fm.b_merge_map[self.sp2], fields, self.assertEqual)
...
class TestAgencyMerger(util.TestCase):
    ...
    def testMerge(self):
        ...
        self.assertEqual(self.fm.a_merge_map[self.a1], self.fm.b_merge_map[self.a2])
        ...
        self.assertEqual(self.fm.a_merge_map[self.a1].agency_id, self.a1.agency_id)
    ...
    def testNoMerge_DifferentId(self):
        ...
        self.assertTrue(self.fm.a_merge_map[self.a1] in merged_schedule.GetAgencyList())
        self.assertTrue(self.fm.b_merge_map[self.a2] in merged_schedule.GetAgencyList())
        ...
        self.assertEqual(self.fm.a_merge_map[self.a1].agency_id, self.a1.agency_id)
        self.assertEqual(self.fm.b_merge_map[self.a2].agency_id, self.a2.agency_id)
...
class TestStopMerger(util.TestCase):
    ...
    def testMerge(self):
        ...
        self.assertEqual(merged_schedule.GetStopList()[0], self.fm.a_merge_map[self.s1])
        self.assertEqual(self.fm.a_merge_map[self.s1], self.fm.b_merge_map[self.s2])
        ...
        CheckAttribs(self.fm.a_merge_map[self.s1], self.s2, fields, self.assertEqual)
    ...
    def testNoMerge_FarApart(self):
        ...
        self.assertNotEqual(
            self.fm.a_merge_map[self.s1].stop_id, self.fm.b_merge_map[self.s2].stop_id
        )
    ...
    def testNoMerge_ZoneId(self):
        ...
        self.assertNotEqual(
            self.fm.a_merge_map[self.s1].zone_id, self.fm.b_merge_map[self.s2].zone_id
        )
    ...
    def testZoneId_SamePreservation(self):
        ...
        self.fm.MergeSchedules()
        self.assertEqual(
            self.fm.a_merge_map[self.s1].zone_id, self.fm.a_merge_map[self.s2].zone_id
        )
    ...
    def testZoneId_MergePreservation(self):
        ...
        self.assertEqual(
            self.fm.a_merge_map[self.s1].zone_id, self.fm.a_merge_map[s3].zone_id
        )
        self.assertEqual(
            self.fm.a_merge_map[s3].zone_id, self.fm.b_merge_map[self.s2].zone_id
        )
...
class TestRouteMerger(util.TestCase):
    ...
    def testNoMerge_SameId(self):
        ...
        # check that the merged ids are different
        self.assertNotEqual(
            self.fm.a_merge_map[self.r1].route_id, self.fm.b_merge_map[self.r2].route_id
        )
...
class TestTripMerger(util.TestCase):
    def setUp(self):
        ...
        self.t1 = transitfeed.Trip(service_period=self.s1, route=self.r1, trip_id="t1")
        self.t2 = transitfeed.Trip(service_period=self.s1, route=self.r1, trip_id="t2")
...
class TestFareMerger(util.TestCase):
    ...
    def testNoMerge_DifferentPrice(self):
        ...
        # check that the merged ids are different
        self.assertNotEqual(
            self.fm.a_merge_map[self.f1].fare_id, self.fm.b_merge_map[self.f2].fare_id
        )
...
class TestShapeMerger(util.TestCase):
    ...
    def testNoMerge_FarEndpoints(self):
        ...
        self.assertNotEqual(
            self.fm.a_merge_map[self.s1].shape_id, self.fm.b_merge_map[self.s3].shape_id
        )
...
class TestFareRuleMerger(util.TestCase):
    ...
    def testMerge(self):
        ...
        self.assertEqual(fare_rule_1.fare_id, self.fm.a_merge_map[self.f1].fare_id)
        self.assertEqual(fare_rule_1.route_id, self.fm.a_merge_map[self.r1].route_id)
        self.assertEqual(fare_rule_2.fare_id, self.fm.a_merge_map[self.f3].fare_id)
        self.assertEqual(fare_rule_2.route_id, self.fm.a_merge_map[self.r1].route_id)
