...
class ProblemReporter(object):
    ...
    def FeedNotFound(self, feed_name, context=None, type=TYPE_ERROR):
        e = FeedNotFound(
            feed_name=feed_name, context=context, context2=self._context, type=type
        )
        self.AddToAccumulator(e)
    ...
    def MissingFile(self, file_name, context=None, type=TYPE_ERROR):
        e = MissingFile(
            file_name=file_name, context=context, context2=self._context, type=type
        )
        self.AddToAccumulator(e)
    ...
    def CsvSyntax(self, description=None, context=None, type=TYPE_ERROR):
        e = CsvSyntax(
            description=description, context=context, context2=self._context, type=type
        )
        self.AddToAccumulator(e)
    ...
    def NoServiceExceptions(self, start, end, type=TYPE_WARNING, context=None):
        e = NoServiceExceptions(
            start=start, end=end, context=context, context2=self._context, type=type
        )
        self.AddToAccumulator(e)
    ...
    def StopWithMultipleRouteTypes(
        self, stop_name, stop_id, route_id1, route_id2, context=None, type=TYPE_WARNING
    ):
    ...
    def DuplicateTrip(
        self, trip_id1, route_id1, trip_id2, route_id2, context=None, type=TYPE_WARNING
    ):
        e = DuplicateTrip(
            trip_id1=trip_id1,
            route_id1=route_id1,
