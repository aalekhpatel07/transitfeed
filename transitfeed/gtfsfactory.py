...
class GtfsFactory(object):
    ...
    def __init__(self):
        ...
        self._file_mapping = {
            "agency.txt": {"required": True, "loading_order": 0, "classes": ["Agency"]},
            "calendar.txt": {
                "required": False,
                "loading_order": None,
            ...
            "stops.txt": {"required": True, "loading_order": 10, "classes": ["Stop"]},
            "stop_times.txt": {
                "required": True,
                "loading_order": None,
                "classes": ["StopTime"],
            },
            "routes.txt": {"required": True, "loading_order": 20, "classes": ["Route"]},
            "transfers.txt": {
                "required": False,
                "loading_order": 30,
                "classes": ["Transfer"],
            },
            "trips.txt": {"required": True, "loading_order": 40, "classes": ["Trip"]},
        }
